...
public class JewelleryEnchant extends Spell {
	...
	public enum EnchantData {
		...
		DRAGONSTONE_AMULET(1702, 1704, 721, 116),
		DRAGONSTONE_NECKLACE(1664, 11105, 721, 116),
		DRAGONSTONE_BRACELET(11115, 11126, 721, -1),
		...
		public static final EnchantData[] VALUES = values();

		public static EnchantData forItem(int fromItemId) {
			for (EnchantData enchantLevelData : EnchantData.VALUES) {
				if (fromItemId == enchantLevelData.item) {
					return enchantLevelData;
				}
			}
			return null;
		}

		public static EnchantLevel getEnchantLevel(int fromItemId) {
			for (EnchantLevel enchantLevel : EnchantLevel.VALUES) {
	...
	public enum EnchantLevel {
		...
		public static final EnchantLevel[] VALUES = values();
	}
	...
	public static void register() { // registering enchant tabs
