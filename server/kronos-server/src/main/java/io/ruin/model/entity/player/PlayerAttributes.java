...
public abstract class PlayerAttributes extends PlayerAttributesRuntime {
	...
	public int completedDiaryTasksCount = 0;
	public int wildernessSlayerTasksCompleted = 0;
	public int slayerMasterUsedCounter = 0;
	public HashSet<String> completedDiaryTasks = new HashSet<>();

	public HashSet<String> claimedDiaryRewards = new HashSet<>();

	public HashSet<String> notifiedDiaryCompletions = new HashSet<>();
	...
	public QuestTab journal = QuestTab.MAIN;
