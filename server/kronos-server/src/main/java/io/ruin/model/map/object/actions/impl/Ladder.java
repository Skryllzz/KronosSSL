...
public class Ladder {
	...
	public static Bounds entrana = new Bounds(2818, 3372, 2822, 3376, 0);
	...
	public static void register() {
		...
		//entrana
		ObjectAction.register(2408, 2820, 3374, 0, "climb-down", (player, obj) -> climb(player, 2831, 9774, 0, false, true, false));

		///draynor sewers
		ObjectAction.register(6436, 3118, 9643, 0, "climb-up", (player, obj) -> climb(player, 3117, 3244, 0, true, true, false));
		ObjectAction.register(17385, 3084, 9672, 0, "climb-up", (player, obj) -> climb(player, 3165, 3251, 0, true, true, false));


		///fally castle
		ObjectAction.register(24077, 3021, 3332, 0, "climb-up", (player, obj) -> climb(player, 3021, 3343, 1, true, true, false));
		ObjectAction.register(24078, 3022, 3332, 1, "climb-down", (player, obj) -> climb(player, 3020, 3332, 0, false, true, false));

		ObjectAction.register(24077, 3018, 3343, 0, "climb-up", (player, obj) -> climb(player, 3024, 3332, 1, true, true, false));
		ObjectAction.register(24078, 3019, 3343, 1, "climb-down", (player, obj) -> climb(player, 3017, 3343, 0, false, true, false));


		//Port dungeon
		ObjectAction.register(17385, 3405, 9907, 0, "climb-up", (player, obj) -> climb(player, 3405, 3506, 0, true, true, false));

		//Lumbride Castle
		ObjectAction.register(14880, 3209, 3216, 0, "climb-down", (player, obj) -> climb(player, 3210, 9616, 0, false, true, false));
		...
		//lumbridge castle
		ObjectAction.register(16671, 3204, 3207, 0, "climb-up", (player, obj) -> Ladder.climb(player, 3205, 3209, 1, true, true, false));
		ObjectAction.register(16672, 3204, 3207, 1, "climb", (player, obj) -> Ladder.climb(player, 3205, 3209, 2, true, true, false));
		ObjectAction.register(16672, 3204, 3207, 1, "climb-up", (player, obj) -> Ladder.climb(player, 3205, 3209, 2, true, true, false));
		ObjectAction.register(16672, 3204, 3207, 1, "climb-down", (player, obj) -> Ladder.climb(player, 3205, 3209, 0, false, true, false));
		ObjectAction.register(16673, 3205, 3208, 2, "climb-down", (player, obj) -> Ladder.climb(player, 3205, 3209, 1, false, true, false));

		ObjectAction.register(16671, 3204, 3229, 0, "climb-up", (player, obj) -> Ladder.climb(player, 3205, 3228, 1, true, true, false));
		ObjectAction.register(16672, 3204, 3229, 1, "climb", (player, obj) -> Ladder.climb(player, 3206, 3229, 2, true, true, false));
		ObjectAction.register(16672, 3204, 3229, 1, "climb-up", (player, obj) -> Ladder.climb(player, 3206, 3229, 2, true, true, false));
		ObjectAction.register(16672, 3204, 3229, 1, "climb-down", (player, obj) -> Ladder.climb(player, 3205, 3228, 0, false, true, false));
		ObjectAction.register(16673, 3205, 3229, 2, "climb-down", (player, obj) -> Ladder.climb(player, 3206, 3229, 1, false, true, false));

		// Ranger Guild
		ObjectAction.register(16679, 2652, 3428, 2, "climb-down", (player, obj) -> Ladder.climb(player, 2653, 3428, 1, false, true, false));
		ObjectAction.register(16679, 2684, 3428, 2, "climb-down", (player, obj) -> Ladder.climb(player, 2683, 3428, 1, false, true, false));
		ObjectAction.register(16679, 2668, 3412, 2, "climb-down", (player, obj) -> Ladder.climb(player, 2668, 3413, 1, false, true, false));
		ObjectAction.register(16679, 2668, 3444, 2, "climb-down", (player, obj) -> Ladder.climb(player, 2668, 3443, 1, false, true, false));
		...
		ObjectAction.register(23584, 2838, 9388, 0, 1, (player, obj) -> player.sendFilteredMessage("This ladder looks broken.. maybe I shouldn't climb up."));
	}
}
