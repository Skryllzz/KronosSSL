...
public class Lever {
	...
	private static void pull(Player player, GameObject lever, int x, int y, String message) {
		// Handle the object event to change
	...
	public static void register() {
		 ...
		 * Edge
		 */
		ObjectAction.register(26761, 3097, 3479, 0, "Wilderness", (player, obj) -> {
		...
		ObjectAction.register(26761, 3097, 3479, 0, "Dungeon", (player, obj) -> pull(player, obj, 2586, 9657, "...and teleport to the Ardougne dungeon."));

		/*
		 * Deserted
		 */
		ObjectAction.register(1815, 3153, 3923, 0, 1, (player, obj) -> pull(player, obj, 2562, 3311, "...and teleport out of the wilderness."));
		ObjectAction.register(1815, 3153, 3923, 0, 2, (player, obj) -> pull(player, obj, 3097, 3479, "...and teleport out of the wilderness."));
		...
		ObjectAction.register(1816, 3067, 10253, 0, "commune", (player, obj) -> {
			if (player.getCombat().checkTb())
				return;
			player.getInstanceTokenInterface().selectedBoss = InstanceMaps.KBD;
