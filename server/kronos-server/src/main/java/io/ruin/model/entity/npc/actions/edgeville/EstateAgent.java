...
public class EstateAgent {
	...
	public static void register() {
		...
		NPCAction.register(ESTATE_AGENT, "relocate", EstateAgent::selectLocation);
		NPCAction.register(ESTATE_AGENT, "redecorate", EstateAgent::selectStyle);
	}
				...
				new OptionsDialogue(
					new Option("How can I get a house?", () -> {
						player.dialogue(new PlayerDialogue("How can I get a house?"),
							new NPCDialogue(npc, "I can sell you a starting house in the Grand Village for " + Color.COOL_BLUE.wrap(NumberUtils.formatNumber(HOUSE_COST)) + " coins. As you increase " +
					...
					new Option("Tell me about houses.", () -> {
						player.dialogue(new PlayerDialogue("Tell me about houses."),
							...
							new NPCDialogue(npc, "There are various other people across Gauntlet who can help you furnish your house. You should start buying planks from the sawmill operator " +
								"just west of me."),
